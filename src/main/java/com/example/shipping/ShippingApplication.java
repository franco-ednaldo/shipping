...
public class ShippingApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("Valor total: " + formatter.format(this.orderService.total(order1)));
        System.out.println("--------------- -----------------");

        final var order2 = new Order(2282, 800.00, 10.0);
        System.out.println("Pedido código: " + order2.code());
        System.out.println("Valor total: " + formatter.format(this.orderService.total(order2)));

        System.out.println("--------------- -----------------");
        final var order3 = new Order(1309, 95.90, 0.0);
        System.out.println("Pedido código: " + order3.code());
        System.out.println("Valor total: " + formatter.format(this.orderService.total(order3)));
    }
}
